...
reverse = {
    b"\x00": "QUERY_RESPONSE",
    b"\x01": "REQUEST_ALIAS",
    b"\x02": "REQUEST_ALIAS_UPDATE",
    b"\x03": "REQUEST_NYM_UPDATE",
    b"\x04": "REQUEST_BLOCK_I",
    b"\x05": "REQUEST_CHAIN_SYNC_I",
    b"\x06": "PUSH_BLOCK_I",
    b"\x07": "REQUEST_BLOCK_S",
    b"\x08": "REQUEST_CHAIN_SYNC_S",
    b"\x09": "PUSH_BLOCK_S",
    b"\x0A": "REQUEST_BC"
}